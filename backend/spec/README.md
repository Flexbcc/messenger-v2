...
| `0200–0299` | Протокол | Протокол обмена сообщениями, пакеты, доставка, маршрутизация |
| `0300–0399` | Криптография | Криптографическая схема |
| `0400–0499` | Клиент | Клиентские приложения |
