...
class AppTheme {
  ...
  static ThemeData _build(
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        displayLarge: text.largeTitle,
        displayMedium: text.largeTitle,
        displaySmall: text.largeTitle,
        headlineLarge: text.largeTitle,
      ...
      navigationRailTheme: NavigationRailThemeData(
        ...
        selectedLabelTextStyle: text.micro.copyWith(
          color: colors.primary,
          fontWeight: FontWeight.w600,
        ),
        unselectedLabelTextStyle: text.micro.copyWith(color: colors.textMuted),
      ),
