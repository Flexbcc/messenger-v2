    ...
    return AppPage(
      ...
      child: _loading
          ...
          ? AppEmptyState(
              ...
              subtitle:
                  'Проверьте подключение к домашней ноде и повторите попытку.',
                  ...
                  if (devices.isEmpty)
                    const SizedBox(
                      ...
                      child: AppEmptyState(
                        ...
                        title: 'Других устройств нет',
                        subtitle:
                            'Подключите телефон или компьютер, чтобы использовать аккаунт на нескольких устройствах.',
                      ),
                    )
                  else
                    AppSettingsGroup(
