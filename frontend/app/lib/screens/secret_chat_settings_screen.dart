...
class _SecretChatSettingsScreenState
  ...
  Future<void> _setPassword() async {
    ...
    final blocking = SecretChatSecurity.blockingErrorsForSetup(password);
    ...
    final warnings = SecretChatSecurity.warningsForSetup(password);
  ...
  Future<void> _pickTimeout() async {
    final next = await showAppBottomSheet<int>(
      context: context,
      builder: (ctx) => Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Padding(
            ...
            child: Text('Таймаут сессии', style: context.textStyles.subtitle),
          ),
