      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            AppSection(
              ...
              child: AppSettingsGroup(
                children: [
                  ...
                  if (snapshot != null)
                    _LiveRow(
                      label: 'Кворум Discovery',
                      value:
                          '${snapshot.reachableDiscoveryCount}/${snapshot.discoveryEndpoints.length}',
                      status: snapshot.discoveryQuorumReachable
                          ? AppStatus.online
                          : AppStatus.error,
                      subtitle: snapshot.discoveryQuorumReachable
                          ? 'Для работы control plane достаточно ${snapshot.requiredDiscoveryCount} источников'
                          : 'Недостаточно независимых источников для безопасного обновления маршрутов',
                    ),
                  _LiveRow(
                ...
                child: AppCard(
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Home Node или WebSocket недоступны. Отправка и получение сообщений сейчас ограничены.',
                          style: text.caption,
                        ),
                      ),
                    ],
            ...
            if (snapshot != null &&
                snapshot.clientReachable &&
                !snapshot.allClientServicesReachable)
              Padding(
                padding: const EdgeInsets.all(AppSpacing.screenPadding),
                child: AppCard(
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          snapshot.discoveryQuorumReachable
                              ? 'Сообщения доступны, но часть вспомогательных сервисов недоступна. Резерв сети временно снижен.'
                              : 'Текущая переписка через Home доступна, но кворума Discovery нет. Обновление маршрутов и новый bootstrap могут быть приостановлены.',
                          style: text.caption,
                        ),
                      ),
                    ],
