                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Icon(
                                snap.recoveryLockActive
                                    ? Icons.gpp_bad_outlined
                                    : Icons.shield_outlined,
                                color: snap.recoveryLockActive
                                    ? colors.danger
                          ...
                          AppButton(
                            ...
                            onPressed: () => Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (_) => const EmergencyLockScreen(),
                              ),
                            ),
                          ),
                        ],
                  ...
                  AppSettingsGroup(
                    ...
                    children: [
                      ...
                      _StatusTile(
                        ...
                        label: 'WebSocket',
                        value: snap.websocketConnected
                            ? 'Подключён'
                            : 'Отключён',
                        color: snap.websocketConnected
                            ? colors.success
                            : colors.warning,
                        showDivider: false,
                      ),
                  ...
                  AppSettingsGroup(
                    ...
                    children: [
                      ...
                      _StatusTile(
                        ...
                        value:
                            '${snap.trustedDeviceCount} / ${snap.deviceCount}',
                        color: colors.warning,
                      ),
                      _StatusTile(
                        icon: Icons.phonelink_lock_outlined,
                        label: 'Подтверждение входа',
                        value: snap.loginApprovalEnabled
                            ? 'Включено'
                            : 'Выключено',
                        color: snap.loginApprovalEnabled
                            ? colors.warning
                            : colors.textMuted,
                      ),
                      _StatusTile(
                        icon: Icons.key_outlined,
                        label: 'Локальный ключ входа',
                        value: snap.authKeysPresent
                            ? 'Есть на устройстве'
                            : 'Отсутствует',
                        color: snap.recoveryLockActive
                            ? colors.danger
                    ...
                    AppSettingsGroup(
                      ...
                      children: [
                        AppTile(
                          ...
                          title: 'Настроить PIN',
                          subtitle:
                              'Дополнительные функции защиты откроются после настройки',
                          trailing: AppTile.chevron(context),
                          onTap: () => Navigator.of(
                            context,
                          ).push(privateModeEntryRoute()),
                          showDivider: false,
                        ),
                      ],
                    )
                    ...
                    AppSettingsGroup(
                      ...
                      children: [
                        ...
                        _StatusTile(
                          icon: Icons.lock_outline,
                          label: 'Хранилище',
                          value: snap.privateVaultUnlocked
                              ? 'Разблокирован'
                              : 'Заблокирован',
                          color: snap.privateVaultUnlocked
                              ? colors.warning
                              : colors.textMuted,
                        ),
                    ...
                    children: [
                      ...
                      if (snap.lastDuressCode != null) ...[
                        _StatusTile(
                          ...
                          value:
                              'Код ${snap.lastDuressCode} · ${snap.lastDuressChannel ?? '—'}',
                          color: colors.warning,
                        ),
                        _StatusTile(
                          icon: Icons.schedule,
                  ...
                  AppSettingsGroup(
                    ...
                    children: [
                      ...
                      AppTile(
                        ...
                        subtitle:
                            'Локально: Настройки → Резервное копирование → Ключи',
                      ),
                      AppTile(
                        leading: Icon(
