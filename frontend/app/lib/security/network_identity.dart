...
class NetworkIdentity {
  ...
  static Future<NetworkUserKey> loadOrCreateUserKey(String networkId) async {
    if (networkId.trim().isEmpty || networkId.length > 256) {
    ...
    final seedBytes = _decodeSeed(seed);
    final pair = await _signer.newKeyPairFromSeed(seedBytes);
  ...
  static List<int> _decodeSeed(String encoded) {
    return decodeBase64Exact(
      encoded,
      expectedBytes: 32,
      field: 'network identity seed',
