...
class SettingsRuntime {
  ...
  Future<void> unblockUser(String userId) async {
    await _lists.remove('contacts.blocked_list', userId);
  }
  ...
  Future<String> backupPassword() =>
      SecureCatalogSecrets.read('backup.password');
  ...
  Future<String> storageS3AccessKey() =>
      SecureCatalogSecrets.read('storage.s3_access_key');
  Future<String> storageS3SecretKey() =>
      SecureCatalogSecrets.read('storage.s3_secret_key');
