...
class _AppLockOverlayState extends ConsumerState<AppLockOverlay>
  ...
  Widget build(BuildContext context) {
    return Stack(
      fit: StackFit.expand,
      children: [
        // Do not merely cover the application with an opaque surface. Flutter
        // Web may still expose covered widgets through its semantics DOM.
        if (!_lock.isLocked) widget.child,
        if (_lock.isLocked)
          Positioned.fill(
            child: Builder(
              builder: (context) {
