...
void main() {
  test('HTTPS invite parses with the secure default policy', () {
    final parsed = BootstrapService.parseInviteLink(
      'https://gateway.example/join?t=NcTeJp0fGWYl2LTa7H14nMwCLvEndN5z-dygoLDgTlI',
    );

    expect(parsed, isNotNull);
    expect(parsed!.gatewayUrl, 'https://gateway.example');
    expect(parsed.token, hasLength(43));
  });
