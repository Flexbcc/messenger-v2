...
import 'package:messenger_app/core/theme/app_radius.dart';
import 'package:messenger_app/core/theme/app_text_styles.dart';
  ...
  switch ('${state.group}/${state.id}') {
    ...
    case 'chat/loading_history':
      return wrapScreenshot(
        _ChatFrame(
          body: const Center(
            child: Icon(Icons.hourglass_top, color: Colors.white54, size: 40),
          ),
        ),
      );
        ...
        _ChatFrame(
          ...
          body: _bubblePane([
            ChatMessageBubble(
              ...
              isMine: false,
              layout: _solo(
                _msg(id: '1', mine: false, plaintext: 'Секретное сообщение'),
              ),
            ),
          ]),
        ),
              ...
              Expanded(
                child: _bubblePane([
                  ChatMessageBubble(
                    ...
                    isMine: false,
                    layout: _solo(
                      _msg(id: '1', mine: false, plaintext: 'Привет'),
                    ),
                  ),
                ]),
              ),
    ...
    case 'chat/date_separator':
      return wrapScreenshot(
        _ChatFrame(
          body: _bubblePane(const [ChatTimeSeparator(label: 'Сегодня')]),
        ),
      );
    case 'chat/duress_banner':
      return wrapScreenshot(
        _ChatFrame(body: const DuressSignalBanner(code: 30)),
      );

    // —— Chat bubbles / statuses ——
    case 'chat/msg_incoming_text':
      return _bubbleShot(
        message: _msg(id: '1', mine: false, plaintext: 'Привет! Как дела?'),
      );
    case 'chat/msg_decrypt_failed':
      return _bubbleShot(
        message: _msg(id: '1', mine: false, decryptFailed: true),
      );
    case 'chat/msg_pending':
      return _bubbleShot(
        message: _msg(id: '1', mine: true, plaintext: 'Отправляется…'),
        status: MessageDeliveryStatus.pending,
      );
    case 'chat/msg_sending':
      return _bubbleShot(
        message: _msg(id: '1', mine: true, plaintext: 'Отправка'),
        status: MessageDeliveryStatus.sending,
      );
    case 'chat/msg_sent':
      return _bubbleShot(
        message: _msg(id: '1', mine: true, plaintext: 'Ушло на сервер'),
        status: MessageDeliveryStatus.sent,
      );
    case 'chat/msg_relay':
      return _bubbleShot(
        message: _msg(id: '1', mine: true, plaintext: 'Через relay'),
        status: MessageDeliveryStatus.relay,
      );
    case 'chat/msg_gateway':
      return _bubbleShot(
        message: _msg(id: '1', mine: true, plaintext: 'Через gateway'),
        status: MessageDeliveryStatus.gateway,
      );
    case 'chat/msg_delivered':
      return _bubbleShot(
        message: _msg(id: '1', mine: true, plaintext: 'Доставлено'),
        status: MessageDeliveryStatus.delivered,
      );
    case 'chat/msg_read':
      return _bubbleShot(
        message: _msg(id: '1', mine: true, plaintext: 'Прочитано'),
    ...
    case 'chat/msg_reply_quote':
      return _bubbleShot(
        message: _msg(
          ...
          mine: true,
          plaintext: 'Ок',
          replyPreview: 'Встретимся в 18:00',
        ),
      );
    case 'chat/msg_pinned':
      return _bubbleShot(
        message: _msg(id: '1', mine: false, plaintext: 'Важное'),
        pinned: true,
      );
    case 'chat/msg_highlighted':
      return _bubbleShot(
        message: _msg(id: '1', mine: false, plaintext: 'Найденное'),
        highlighted: true,
      );
    case 'chat/msg_file':
      return wrapScreenshot(
    ...
    case 'call/minimized':
      return wrapScreenshot(
        _MinimizedCallBar(peerName: 'Анна', status: '01:23'),
      );
    case 'call/ended':
    ...
    case 'calls/row_completed_out':
      return wrapScreenshot(
        _CallsHistoryScaffold(
          rows: [
            _CallHistoryRow(
              name: 'Анна',
              subtitle: 'Исходящий · 1:20',
        ...
        ListView(
          children: const [
            ...
            ListTile(
              ...
              title: Text('Борис'),
              subtitle: Text('доверенный'),
            ),
            ListTile(
              leading: CircleAvatar(child: Text('К')),
              title: Text('Кира'),
    ...
    case 'devices/loading':
      return wrapScreenshot(
        const Center(
          child: Icon(Icons.hourglass_top, size: 40, color: Colors.white54),
        ),
      );
    case 'devices/error':
      return wrapScreenshot(
    ...
    case 'devices/empty':
      return wrapScreenshot(
        _staticEmpty(icon: Icons.devices_other, title: 'Нет устройств'),
      );
    case 'devices/list':
      return wrapScreenshot(
        ListView(
          children: const [
            ListTile(
              ...
              title: Text('MacBook'),
              subtitle: Text('Это устройство · сейчас'),
            ),
            ListTile(
    ...
    case 'auth/app_lock_wrong':
      return wrapScreenshot(
        _PinPad(title: 'Введите PIN', error: 'Неверный PIN'),
      );
        ...
        ListView(
          children: const [
            ListTile(
              ...
              title: Text('Профиль'),
              subtitle: Text('Имя, username, QR'),
            ),
            ListTile(
              leading: Icon(Icons.shield_outlined),
              title: Text('Приватность и защита'),
            ),
            ListTile(
      ...
      return wrapScreenshot(
        ListView(
          children: const [
            ...
            SwitchListTile(
              title: Text('Компактный режим'),
              value: false,
              onChanged: null,
            ),
            SwitchListTile(
              title: Text('Уменьшить движение'),
              value: false,
              onChanged: null,
            ),
          ],
        ...
        ListView(
          children: const [
            ListTile(
              ...
              subtitle: Text('Локально + нода'),
            ),
            ListTile(title: Text('Медиа'), subtitle: Text('Кэш · 120 МБ')),
            ListTile(
              title: Text('Последняя синхронизация'),
      ...
      return wrapScreenshot(
        ListView(
          children: const [
            ListTile(
              title: Text('Мягкая'),
              subtitle: Text('Блокировка приложения'),
            ),
            ListTile(
              title: Text('Полная'),
              subtitle: Text('Выход на всех устройствах'),
            ),
            ListTile(
              title: Text('Критическая'),
              subtitle: Text('Стирание локальных данных'),
            ),
          ],
        ),
      );
    ...
    default:
      return wrapScreenshot(
        Center(child: Text('Missing scene: ${state.group}/${state.id}')),
      );
  }
}
      ...
      child: Column(
        ...
        children: [
          ...
          FilledButton(
            ...
            child: loading ? const Text('…') : Text(primary),
          ),
          if (secondary != null)
