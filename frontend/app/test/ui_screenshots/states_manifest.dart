...
const kScreenshotStates = <ScreenshotState>[
  ...
  ScreenshotState(
    group: 'chat',
    id: 'loading_history',
    titleRu: 'Загрузка истории',
  ),
  ScreenshotState(
    group: 'chat',
    id: 'unreachable',
    titleRu: 'Собеседник недоступен',
  ),
  ScreenshotState(group: 'chat', id: 'offline', titleRu: 'Нет соединения (WS)'),
  ScreenshotState(
    group: 'chat',
    id: 'secret_banner',
    titleRu: 'Секретный сеанс',
  ),
  ScreenshotState(group: 'chat', id: 'typing', titleRu: 'Индикатор набора'),
  ScreenshotState(
    group: 'chat',
    id: 'composer_reply',
    titleRu: 'Ответ в композере',
  ),
  ScreenshotState(
    group: 'chat',
    id: 'date_separator',
    titleRu: 'Разделитель даты',
  ),
  ScreenshotState(
    group: 'chat',
    id: 'msg_incoming_text',
    titleRu: 'Входящее текстовое',
  ),
  ScreenshotState(
    group: 'chat',
    id: 'msg_decrypt_failed',
    titleRu: 'Не удалось расшифровать',
  ),
  ...
  ScreenshotState(
    group: 'chat',
    id: 'msg_reply_quote',
    titleRu: 'Цитата ответа',
  ),
  ScreenshotState(
    group: 'chat',
    id: 'msg_pinned',
    titleRu: 'Закреплённое сообщение',
  ),
  ScreenshotState(
    group: 'chat',
    id: 'msg_highlighted',
    titleRu: 'Подсветка поиска',
  ),
  ScreenshotState(group: 'chat', id: 'msg_file', titleRu: 'Файл'),
  ScreenshotState(
    group: 'chat',
    id: 'msg_image_placeholder',
    titleRu: 'Фото (плейсхолдер)',
  ),
  ScreenshotState(
    group: 'chat',
    id: 'msg_video_placeholder',
    titleRu: 'Видео (плейсхолдер)',
  ),
  ...
  ScreenshotState(
    group: 'call',
    id: 'outgoing_ringing',
    titleRu: 'Исходящий — звоним',
  ),
  ScreenshotState(
    group: 'call',
    id: 'incoming_ringing',
    titleRu: 'Входящий — звонок',
  ),
  ScreenshotState(
    group: 'call',
    id: 'active_audio',
    titleRu: 'Активный аудиозвонок',
  ),
  ScreenshotState(
    group: 'call',
    id: 'active_video',
    titleRu: 'Активный видеозвонок',
  ),
  ScreenshotState(group: 'call', id: 'active_muted', titleRu: 'Микрофон выкл.'),
  ScreenshotState(
    group: 'call',
    id: 'active_speaker',
    titleRu: 'Громкая связь',
  ),
  ScreenshotState(group: 'call', id: 'active_hold', titleRu: 'На удержании'),
  ScreenshotState(
    group: 'call',
    id: 'waiting_network',
    titleRu: 'Ожидание сети',
  ),
  ...
  ScreenshotState(
    group: 'calls',
    id: 'empty_missed',
    titleRu: 'Нет пропущенных',
  ),
  ScreenshotState(
    group: 'calls',
    id: 'row_completed_out',
    titleRu: 'Завершён исходящий',
  ),
  ScreenshotState(
    group: 'calls',
    id: 'row_missed_in',
    titleRu: 'Пропущенный входящий',
  ),
  ...
  ScreenshotState(
    group: 'conv_list',
    id: 'empty',
    titleRu: 'Список чатов пуст',
  ),
  ScreenshotState(
    group: 'conv_list',
    id: 'populated',
    titleRu: 'Чаты с unread/draft/mute',
  ),
  ScreenshotState(
    group: 'conv_list',
    id: 'search_empty',
    titleRu: 'Поиск без результатов',
  ),
  ...
  ScreenshotState(
    group: 'devices',
    id: 'loading',
    titleRu: 'Устройства — загрузка',
  ),
  ScreenshotState(
    group: 'devices',
    id: 'error',
    titleRu: 'Устройства — ошибка',
  ),
