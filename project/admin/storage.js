(function () {
  ...
  const cancelBtn = document.getElementById("cancelStorageBtn");

  function setEditing(editing) {
    form.classList.toggle("is-editing", editing);
    form.classList.toggle("is-locked", !editing);
    form.querySelectorAll("input, select, textarea").forEach((el) => { el.disabled = !editing; });
    form.querySelectorAll(".storage-config-action").forEach((el) => { el.disabled = !editing; });
