    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const _FaqItem(
            question: 'Почему не работают звонки в браузере?',
            answer: 'WebRTC требует HTTPS (или localhost). Откройте PWA по https://… '
                'или используйте 127.0.0.1. Подробнее: Настройки → Система → «Звонки в браузере».',
          ),
          const _FaqItem(
