...
class BackupCrypto {
  ...
  static Future<Map<String, dynamic>> encryptJson(
    ...
    final salt = List<int>.generate(16, (i) => (password.codeUnitAt(i % password.length) ^ (i * 17)) & 0xff);
  ...
  static Uint8List encodeEnvelope(Map<String, dynamic> envelope) =>
      Uint8List.fromList(utf8.encode(const JsonEncoder.withIndent('  ').convert(envelope)));
}
