...
class NetworkBootstrap {
  ...
  /// Push proxy URL — опционален, null если push не настроен на сервере.
  final String? pushProxyUrl;
  ...
  factory NetworkBootstrap.fromJson(Map<String, dynamic> json) {
    ...
    return NetworkBootstrap(
      ...
      pushProxyUrl: json['push_proxy_url'] as String?,
  ...
  Map<String, dynamic> toJson() => {
        ...
        if (pushProxyUrl != null) 'push_proxy_url': pushProxyUrl,
      };
  ...
  NetworkBootstrap copyWith({
    ...
    return NetworkBootstrap(
      ...
      pushProxyUrl: pushProxyUrl ?? this.pushProxyUrl,
    );
  }
}
