...
from app.key_rotation import get_active_signing_key, get_active_public_key_b64
...
def _get_signing_key() -> SigningKey:
    # A signing failure must stop record publication. Silently switching to a
    # file key would change the advertised trust root during a DB outage.
