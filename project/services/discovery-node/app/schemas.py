...
from app.node_registration_schemas import HeartbeatRequest, RegisterNodeCapability
...
class RegisterUserRecord(BaseModel):
    ...
    user_id: Identifier
    home_node_url: ServiceUrl
    display_name: Optional[DisplayText] = None
    auth_public_key: EncodedKey  # base64 Ed25519 public key
    cluster_id: Identifier = "default"
    login: Optional[DisplayText] = None
...
class QuarantineModeRequest(BaseModel):
    ...
    mode: str = Field(pattern=r"^(off|warn|isolate)$")
