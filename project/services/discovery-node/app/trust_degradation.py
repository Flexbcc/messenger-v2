...
from app.config import (
    TRUST_DEGRADATION_CHECK_INTERVAL_SECONDS as DEGRADATION_CHECK_INTERVAL_SECONDS,
    TRUST_DEGRADATION_MODE,
    TRUST_DEGRADE_L1_AFTER_DAYS as DEGRADE_L1_AFTER_DAYS,
    TRUST_DEGRADE_L2_AFTER_DAYS as DEGRADE_L2_AFTER_DAYS,
)
