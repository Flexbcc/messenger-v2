...
from app.config import (
    TRUST_PROMOTION_MIN_CHALLENGE_TYPES as MIN_PROMOTION_TYPES,
    TRUST_PROMOTION_MIN_OBSERVATIONS as MIN_PROMOTION_OBSERVATIONS,
    TRUST_PROMOTION_MIN_OBSERVERS as MIN_PROMOTION_OBSERVERS,
    TRUST_PROMOTION_MIN_SUCCESS_BPS as MIN_PROMOTION_SUCCESS_BPS,
)
