...
async def _heartbeat_telemetry() -> dict[str, Any]:
    ...
    try:
        ...
        # ``disk_path`` is useful to the local owner monitor, but it is not a
        # federated metric and is intentionally absent from HeartbeatRequest.
        # Sending it makes strict Discovery schemas reject the whole
        # heartbeat with HTTP 422.
        host_metrics.pop("disk_path", None)
