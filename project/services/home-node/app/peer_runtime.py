...
async def refresh_signed_peer_set(
    *,
    ...
    view = aggregate_discovery_peer_view(
        ...
        minimum_sources=settings.peer_minimum_discovery_sources,
    )
    ...
    for candidate in view.candidates:
        ...
        if (
            ...
            < settings.peer_minimum_discovery_sources
        ):
            continue
    ...
    selection = select_peer_set(
        ...
        policy=PeerSelectionPolicy(
            guard_count=settings.peer_guard_count,
            rotating_count=settings.peer_rotating_count,
            reserve_count=settings.peer_reserve_count,
            minimum_sources=settings.peer_minimum_discovery_sources,
        ),
    )
    signed_deadline = min(
