...
MESH_SYNC_INTERVAL_SECONDS = _env_int(
    "MESH_SYNC_INTERVAL_SECONDS", 300, minimum=10, maximum=86400
)
MESH_SYNC_CLUSTER_ONLY = _env_bool("MESH_SYNC_CLUSTER_ONLY", False)
