...
class RelayTransportAdapter:
    def __init__(
        ...
        *,
        ...
        websocket_max_links: int = 15,
        websocket_idle_timeout_seconds: float = 120.0,
    ) -> None:
        if mode not in {
            "http", "websocket-preferred", "websocket-required",
            "quic-preferred", "quic-required",
        ...
        self._websocket = RelayWebSocketClient(
            ...
            max_links=websocket_max_links,
            idle_timeout_seconds=websocket_idle_timeout_seconds,
        )
        self._quic = None
    ...
    def status_snapshot(self) -> dict[str, Any]:
        return {
            "mode": self.mode,
            "websocket": self._websocket.status_snapshot(),
            "quic_initialized": self._quic is not None,
        }
